...
#' @noRd
#' 
plot.glmnetr_0_5_5 = function(x, gam=NULL, lambda.lo=NULL, title=NULL,comment=TRUE, ...) {
  object = x 
...
#' @noRd
#' 
plot.cv.glmnetr_0_5_5 = function(x, gam=NULL, lambda.lo=NULL, plup=0, title=NULL, coefs=FALSE, comment=TRUE, ...) {
  object = x 
  method=0 
  if (coefs==TRUE) {
    plot.glmnetr(object, gamma=gam, lambda.lo=lambda.lo, title=NULL) 
  } else {

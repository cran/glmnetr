...
#library( glmnetr )
source("~/Documents/Rpackages/glmnetr_supl/_load_glmnetr_vig_240708.R" , echo=FALSE)
```
# The functions
...
load( file="~/Documents/Rpackages/glmnetr_supl/using_ann_tab_cv_outputs_240710.RLIST" ) 
```
...
save( ann_tab_cox_ex1, nested_cox_fit_ex2,  
      file="~/Documents/Rpackages/glmnetr_supl/using_ann_tab_cv_outputs_240710.RLIST") 
```

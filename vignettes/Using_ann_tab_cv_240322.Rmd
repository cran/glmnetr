...
source("~/Documents/Rpackages/glmnetr_supl/_load_glmnetr_vig_240322.R" , echo=FALSE)
```
# The functions
...
load( file="~/Documents/Rpackages/glmnetr_supl/using_ann_tab_cv_outputs_240322.RLIST" ) 
```
...
save( ann_tab_cox_ex1, nested_cox_fit_ex2, nested_nrm_fit_ex3, nested_bin_fit_ex4 , nested_nrm_fit_ex5 ,  
      file="~/Documents/Rpackages/glmnetr_supl/using_ann_tab_cv_outputs_240322.RLIST") 
```
...
nested_nrm_fit_ex2 = nested.glmnetr(xs=xs, y_=y_, family="gaussian", dolasso=1,
        seed=c(17820414,95337508), doann=1, ensemble=c(1,0,0,1), folds_n=10, do_ncv=0, track=-1)
```
We can inspect numerically the fit by 
```{r  nested.glminetr() ann_fit_1 predicteds 2 }
preds = predict_ann_tab(nested_nrm_fit_ex2, xs) 
...
nested_nrm_fit_ex5 = nested.glmnetr(xs=simdata$xs,y_=simdata$y_,
                    ...
                    ensemble=ensemble,folds_n=3,steps_n=40,track=0)
## print a short summary 
nested_nrm_fit_ex5
```
...
save( ann_tab_cox_ex1, nested_cox_fit_ex2, nested_nrm_fit_ex2, nested_bin_fit_ex4 , nested_nrm_fit_ex5 , file="~Kremers/Documents/Rpackages/glmnetr_supl/using_ann_tab_cv_outputs_240126.RLIST") 
```
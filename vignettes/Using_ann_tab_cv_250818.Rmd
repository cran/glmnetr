...
load( file="~/Documents/Rpackages/glmnetr_supl/using_ann_tab_cv_outputs_250818.RLIST" ) 
```
...
save( ann_tab_cox_ex1, nested_cox_fit_ex2,  
      file="~/Documents/Rpackages/glmnetr_supl/using_ann_tab_cv_outputs_250818.RLIST") 
```

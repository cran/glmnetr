...
load( file="~/Documents/Rpackages/glmnetr_supl/using_glmnetr_outputs_241228.RLIST" ) 
```
...
save( nested.cox.fit , 
      file="~/Documents/Rpackages/glmnetr_supl/using_glmnetr_outputs_241228.RLIST" ) 
```
...
calplot(nested.bin.boot.fit, wbeta=5, plotfold=1)  
```
...
#calplot(nested.bin.fit, wbeta=5, plotfold=1) 
```

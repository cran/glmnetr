...
load( file="~Kremers/Documents/Rpackages/glmnetr_supl/using_stepreg_outputs_240301.RLIST" ) 
```
...
save( cv.stepwise.fit , nested.gau.fit , file="~Kremers/Documents/Rpackages/glmnetr_supl/using_stepreg_outputs_240301.RLIST" ) 
```
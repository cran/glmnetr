...
load( file="~Kremers/Documents/Rpackages/glmnetr_supl/using_ann_tab_cv_outputs_240301.RLIST" ) 
```
...
save( ann_tab_cox_ex1, nested_cox_fit_ex2, nested_nrm_fit_ex3, nested_bin_fit_ex4 , nested_nrm_fit_ex5 ,  file="~Kremers/Documents/Rpackages/glmnetr_supl/using_ann_tab_cv_outputs_240301.RLIST") 
```
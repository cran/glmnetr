...
load( file="~/Documents/Rpackages/glmnetr_supl/using_stepreg_outputs_250818.RLIST" ) 
...
save( cv.stepwise.fit , nested.gau.fit , file="~/Documents/Rpackages/glmnetr_supl/using_stepreg_outputs_250818.RLIST" )
```
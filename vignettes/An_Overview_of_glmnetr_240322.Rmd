...
source("~/Documents/Rpackages/glmnetr_supl/_load_glmnetr_vig_240322.R" , echo=TRUE)
```
# The Package 
...
load( file="~/Documents/Rpackages/glmnetr_supl/using_glmnetr_outputs_240322.RLIST" ) 
```
...
plot(nested.cox.fit, type="coefs")
```
...
save( nested.cox.fit , nested.gau.fit , file="~/Documents/Rpackages/glmnetr_supl/using_glmnetr_outputs_240322.RLIST" ) 
```
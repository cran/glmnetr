...
```{r  Nested cross-validation evaluation for multiple machine learning models-gaussian, include=FALSE, eval=FALSE}
nested.gau.fit = nested.glmnetr(xs,NULL,y_,NULL,family="gaussian",
      ...
      folds_n=10, seed=219301029, track=1) 
```
and then plotting we see
```{r  Nested cross-validation calibration plot - gaussian, include=TRUE, eval=TRUE}
calplot(nested.gau.fit, wbeta=7)
```
a small but probably not significant deviation from the ideal calibration line, the identity function. 
